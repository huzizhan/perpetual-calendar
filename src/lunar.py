...
LUNAR_YEAR_INFO = [
    ...
    0x0a5d0, 0x14573, 0x052b0, 0x0a9a8, 0x0e950, 0x06aa0,  # 1954–1959
    ...
    0x0b5a0, 0x195a6, 0x095b0, 0x049b0, 0x0a974, 0x0a4b0,  # 1978–1983
    ...
    0x0daa0, 0x16aa6, 0x056d0, 0x04ae0, 0x0a9d4, 0x0a2d0,  # 2092–2097
...
SOLAR_FESTIVAL_INTRO: dict[str, str] = {
    "元旦": (
        "元旦即公历1月1日，是全世界普遍采用的公历新年。「元」意为开始，「旦」"
        "意为日出，合起来就是新年的第一个黎明。1949年新中国成立后正式采用公历纪元，"
        "元旦成为法定节假日。这一天全国放假，各地举行跨年倒计时、新年音乐会等活动，"
        "人们互道新年祝福，以崭新的姿态迎接新一年的到来。"
    ),
    "劳动节": (
        "五一国际劳动节源于1886年芝加哥工人为争取八小时工作制举行的大罢工。"
        "1889年第二国际将5月1日定为国际劳动节。1949年新中国将其定为法定假日，"
        "表彰工人阶级的贡献。每年五一前后各地表彰劳动模范，"
        "同时「五一黄金周」（1999-2007年曾实行七天长假）至今仍是旅游出行高峰。"
    ),
    "儿童节": (
        "六一国际儿童节源于1949年国际民主妇女联合会的决议，旨在保障各国儿童的"
        "生存权、保健权和受教育权。1950年新中国首次庆祝儿童节，毛泽东题词"
        "「庆祝儿童节」。这一天全国不满14周岁的儿童放假，学校组织文艺表演、"
        "游园活动，社会各界关注儿童成长，孩子们在欢乐中感受关爱与祝福。"
    ),
    "建党节": (
        "七一建党节纪念1921年7月中国共产党第一次全国代表大会的召开。"
        "1921年7月23日中共一大在上海开幕，后转移到嘉兴南湖红船继续举行。"
        "1938年毛泽东将7月1日定为党的诞生纪念日。每年这一天全国党员开展"
        "纪念活动、重温入党誓词，「七一勋章」颁授仪式也在这一天举行。"
    ),
    "建军节": (
        "八一建军节纪念1927年8月1日的南昌起义，这是中国共产党独立领导武装斗争、"
        "创建人民军队的开端。起义由周恩来、贺龙、叶挺、朱德、刘伯承等领导，"
        "打响了武装反抗国民党反动派的第一枪。每年八一前后举行阅兵、慰问官兵等活动，"
        "南昌起义纪念塔和八一广场成为重要的爱国主义教育基地。"
    ),
    "国庆节": (
        "十一国庆节纪念1949年10月1日中华人民共和国成立。这一天毛泽东在天安门城楼"
        "庄严宣告「中华人民共和国中央人民政府今天成立了」。国庆节是中国的「黄金周」"
        "长假（10月1日至7日），天安门广场举行升旗仪式和大型花坛展览，"
        "逢五逢十年份举行盛大阅兵式。国庆承载着国家记忆，是全民爱国情怀的集中表达。"
    ),
    "教师节": (
        "9月10日是中国教师节。1985年全国人大常委会确立，旨在弘扬尊师重教的传统美德。"
        "这一天学生向老师献花、送贺卡表达感恩之情。孔子诞生于公元前551年9月28日，"
        "台湾地区以此为教师节。教师被誉为「人类灵魂的工程师」，"
        "教师节是对教育工作者辛勤耕耘的崇高致敬。"
    ),
}
...
def _lunar_month_days(lunar_year: int, lunar_month: int, is_leap: bool = False) -> int:
    """农历某月天数（bit 16-month: 1=大30天, 0=小29天）"""
    info = LUNAR_YEAR_INFO[lunar_year - 1900]
    leap_month = info & 0xf
    if is_leap and lunar_month == leap_month:
        return 30 if (info >> 16) & 1 else 29
    return 30 if (info >> (16 - lunar_month)) & 1 else 29
